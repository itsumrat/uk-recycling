...
class _NewInputsState extends State<NewInputs> {
                      ...
                      Expanded(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2<String>(
                            ...
                            items: _tableList!.map((item) => DropdownMenuItem<String>(
 ...
 void _createNewProduction() async{
    ...
    var res = await ProductionController.createNewProduction(production_date: AppConst.serverDateFormat(DateTime.now()), table: selectedValue.toString(), assigned_to: selectUser.toString());
    if(res.statusCode == 200){
      Get.to(ShowNewlyCretaeProduction(pId: jsonDecode(res.body)["data"]["id"].toString(),));
